...
const resources = {
  ...
  fr: {
  translation: {
    heading: "NAF - Questionnaire sur le distributeur automatique de médicaments",
    paragraphs: {
      intro1: "Nous prévoyons d'installer des distributeurs automatiques de médicaments dans votre région...",
      intro2: "Veuillez prendre quelques minutes pour répondre à ce questionnaire..."
    },
    selectLanguage: "Choisir la langue",
    formSubmitted: "✅ Merci ! Votre questionnaire a été envoyé.",
    next: "Suivant",
    back: "Retour",
    submit: "Envoyer",
    langEnglish: "Anglais",
    langMoroccan: "Marocain (Darija)",
    langFrench: "Français",
    otherOptionLabel: "Autre :",
    pleaseSpecifyPlaceholder: "Veuillez préciser",
    enterHerePlaceholder: "Entrez ici",
    sections: {
      a: "A : À propos de vous",
      b: "B : Obtention des médicaments",
      c: "C : Utiliseriez-vous cette machine ?",
      d: "D : Parler au médecin",
      e: "E : Que devrait contenir la machine ?",
      f: "F : Où installer ces machines ?",
      g: "G : Sécurité et confiance",
      h: "H : Vos idées",
      i: "I : Rester en contact",
    },
    validation: {
      required: "Ce champ est obligatoire.",
      atLeastOne: "Veuillez sélectionner au moins une option.",
      emailInvalid: "Veuillez entrer une adresse email valide.",
      phoneInvalid: "Veuillez entrer un numéro de téléphone valide.",
      nameRequired: "Le nom est requis pour répondre",
    },
    questions: {
      q1: "1. Quel âge avez-vous ?",
      q2: "2. Genre :",
      q3: "3. Que faites-vous ?",
      q4: "4. Avez-vous déjà entendu parler des distributeurs automatiques de médicaments ?",
      q5: "5. À quelle fréquence achetez-vous des médicaments ?",
      q6: "6. Avez-vous déjà eu besoin d’un médicament lorsque la pharmacie était fermée ?",
      q7: "7. Y a-t-il une pharmacie près de chez vous (dans un rayon de 2 km) ?",
      q8: "8. Les horaires de la pharmacie vous conviennent-ils ?",
      q9: "9. Si nous installions une machine près de chez vous, l’utiliseriez-vous ?",
      q10: "10. Seriez-vous à l’aise d’acheter des médicaments à partir d’une machine ?",
      q11: "11. Avez-vous déjà utilisé un distributeur automatique (snacks, boissons...) ?",
      q12: "12. Feriez-vous confiance à l’achat de médicaments via une machine ?",
      q13: "13. Quand utiliseriez-vous cette machine ? (vous pouvez choisir plusieurs réponses)",
      q14: "14. Cette machine vous permettra de parler à un médecin via vidéo/audio avant de donner le médicament. Seriez-vous à l’aise ?",
      q15: "15. Quelle importance accordez-vous à la confidentialité lors de la conversation avec le médecin ?",
      q16: "16. Combien de temps seriez-vous prêt à attendre qu’un médecin soit disponible ?",
      q17: "17. Feriez-vous confiance au médecin avec lequel vous communiquez via la machine ?",
      q18: "18. Quels médicaments ou produits souhaitez-vous trouver dans la machine ? (Choisissez vos 3 préférés)",
      q19: "19. Quelle importance accordez-vous à la disponibilité 24h/24 et 7j/7 ?",
      q20: "20. Où ces machines seraient-elles les plus utiles ? (Choisissez 2 options)",
      q21: "21. Jusqu’où seriez-vous prêt à marcher pour utiliser cette machine en cas de besoin urgent ?",
      q22: "22. Craignez-vous de recevoir des médicaments contrefaits ou périmés via la machine ?",
      q23: "23. Feriez-vous confiance à la machine si elle est gérée par une pharmacie agréée ?",
      q24: "24. Serait-il utile de voir le contrôle de température et les certificats de sécurité sur la machine ?",
      q25: "25. La machine devrait-elle afficher un numéro de téléphone pour obtenir de l’aide ?",
      q26: "26. Comment souhaitez-vous recevoir les instructions d’utilisation ?",
      q27: "27. Quelle langue préférez-vous ? (vous pouvez en choisir plusieurs)",
      q28: "28. Recommanderiez-vous d’installer ces machines dans votre quartier ?",
      q29: "29. Les médicaments sur ordonnance devraient-ils être disponibles après approbation d’un médecin ?",
      q30: "30. Qu’est-ce qui vous inquiète le plus à propos de ces machines ?",
      q31: "31. Autres commentaires ou suggestions ?",
      q32: "32. Souhaitez-vous essayer ce service lors de son lancement dans votre région ?",
      q33: "33. Seriez-vous prêt à payer un petit supplément (5–10%) pour accéder aux médicaments et produits de santé 24/7 ?",
      q34: "34. Quelle fourchette de prix vous semble raisonnable pour les médicaments courants (ex : analgésiques, vitamines) ?",
      q35: "35. Feriez-vous confiance à une machine supervisée par une pharmacie ou un médecin agréé ?",
      q36: "36. Feriez-vous confiance à une machine délivrant des médicaments via une application ou QR code si l’emballage est scellé et vérifié ?",
      q37: "37. Votre nom :",
      q38: "38. Numéro de téléphone :",
      q39: "39. Email (si vous en avez un) :",
      q40: "40. Ville / Commune :",
      q41: "41. Quartier / Zone :",
    },
    options: {
      q1: { under18: "Moins de 18 ans", "1825": "18–25 ans", "2640": "26–40 ans", "4160": "41–60 ans", over60: "Plus de 60 ans" },
      q2: { male: "Homme", female: "Femme", prefernottosay: "Préfère ne pas dire" },
      q3: { student: "Étudiant", haveajob: "Travail", workinhealthcare: "Santé", runmyownbusiness: "Entreprise", retiredstayathome: "Retraité / À la maison" },
      q4: { yes: "Oui", no: "Non" },
      q5: { everyweek: "Chaque semaine", everymonth: "Chaque mois", every23months: "Tous les 2–3 mois", notoften: "Rarement" },
      q6: { yes: "Oui", no: "Non" },
      q7: { yes: "Oui", no: "Non" },
      q8: { yes: "Oui", no: "Non" },
      q9: { yesdefinitely: "Oui, certainement", maybe: "Peut-être", no: "Non" },
      q10: { yes: "Oui", no: "Non", maybe: "Peut-être" },
      q11: { yes: "Oui", no: "Non" },
      q12: { yes: "Oui", no: "Non", onlyifapprovedbyhealthauthorities: "Seulement si approuvé" },
      q13: { inemergencies: "En urgence", whenpharmaciesareclosed: "Quand pharmacies fermées", duringworkhours: "Heures de travail", forpersonalprivatepurchases: "Usage personnel" },
      q14: { yesverycomfortable: "Très à l’aise", alittlecomfortable: "Un peu à l’aise", notcomfortable: "Pas à l’aise", ineedtoknowmore: "Je veux en savoir plus" },
      q15: { veryimportant: "Très important", important: "Important", doesntmattermuch: "Peu importe", notimportant: "Pas important" },
      q16: { upto5minutes: "Jusqu’à 5 min", "510minutes": "5–10 min", "1020minutes": "10–20 min", morethan20minutes: "Plus de 20 min", iwouldntwait: "Je n’attendrais pas" },
      q17: { yessameasmeetinginperson: "Oui, comme en personne", onlyforsmallhealthproblems: "Pour petits problèmes", noiprefermeetingfacetoface: "Non, préfère en face-à-face", dependsonthesituation: "Dépend de la situation" },
      q18: { painrelieversfevermedicine: "Antalgiques / Médicaments contre la fièvre", coldcoughflumedicine: "Rhume, toux, grippe", bandagesantisepticsfirstaiditems: "Bandages, désinfectants", sanitarypadsandhygieneproducts: "Protections hygiéniques", vitaminsandsupplements: "Vitamines / Compléments", covidhealthtestkits: "Tests COVID / Santé", contraceptivesandpregnancytests: "Contraceptifs / Tests de grossesse", prescriptionmedicines: "Médicaments sur ordonnance", other: "Autre" },
      q19: { veryimportant: "Très important", important: "Important", neutral: "Neutre", notimportant: "Pas important" },
      q20: { hospitalsclinics: "Hôpitaux / Cliniques", busortrainstations: "Gares / Stations de bus", officebuildings: "Bureaux", shoppingmalls: "Centres commerciaux", schoolsuniversities: "Écoles / Universités", apartmentbuildings: "Immeubles résidentiels", publicplaces: "Lieux publics", villagesorremoteareas: "Villages / Zones isolées" },
      q21: { within5minutes: "Moins de 5 min", "510minutes": "5–10 min", "1015minutes": "10–15 min", iwouldntuseit: "Je ne l'utiliserais pas" },
      q22: { veryworried: "Très inquiet", alittleworried: "Un peu inquiet", notworried: "Pas inquiet" },
      q23: { yes: "Oui", no: "Non", needmoreinformation: "Besoin de plus d'informations" },
      q24: { yes: "Oui", no: "Non" },
      q25: { yes: "Oui", no: "Non" },
      q26: { voiceinstructions: "Instructions vocales", writtenonscreen: "Écrit à l'écran", both: "Les deux", dontneedinstructions: "Pas besoin d'instructions" },
      q27: { arabic: "Arabe", darija: "Darija", french: "Français", english: "Anglais", other: "Autre" },
      q28: { yes: "Oui", no: "Non", maybe: "Peut-être" },
      q29: { yes: "Oui", no: "Non", onlyforrefills: "Seulement pour renouvellements" },
      q30: { medicinequalityandsafety: "Qualité et sécurité des médicaments", nothavingadoctornearbytoaskquestions: "Pas de médecin à proximité pour poser des questions", privacywhentalkingtodoctor: "Confidentialité lors de la conversation avec le médecin", machinemightnotworkproperly: "La machine pourrait ne pas fonctionner correctement", nothingworriesme: "Rien ne m'inquiète" },
       q32: { yesiminterested: "Oui, je suis intéressé(e)", no: "Non", maybe: "Peut-être" }
    }
  }
}
